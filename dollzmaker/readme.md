...
1. **Asset Path Alignment:** Ensure relative HTML/CSS links match the hyphenated folder structure to avoid broken image links on web servers (e.g., Neocities/GitHub Pages).
2. **Layer Order (`z-index`):** Standardize element layering when defining canvas items (Bases: `1–5` | Tops/Bottoms: `6–14` | Hair/Heads: `15` | Accessories: `20+`).
3. **File Formats:** Keep images in `.gif` or `.png` formats with transparent backgrounds.
